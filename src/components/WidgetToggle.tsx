...
const ToggleIcon = ({isOpen, image}: {isOpen?: boolean; image?: string}) => {
  const closed = (
    <React.Fragment>
      <Path
        variants={{
  ...
  if (isOpen) {
    ...
    return <Image src={image} style={{maxHeight: 40, maxWidth: 40}} />;
  }
};
...
export const WidgetToggle = ({
  ...
  return (
    ...
    >
      ...
      >
        <ToggleIcon
          image='https://poolmessenger.com/question.png'
          isOpen={isOpen}
        />
      </Button>
    </Flex>
